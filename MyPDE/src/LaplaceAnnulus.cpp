...
int main(int argc, char *argv[]) {
  ...
  auto innerBoundary = gmsh.GetPhysicalGroup("InnerBoundary");
  auto dirichletBoundary = Unite(outerBoundary, innerBoundary);
  ...
  visualize.WriteVtuFile("LaplaceAnnulus.vtu");
}
