...
int main(int argc, char *argv[]) {
  ...
  auto dirichletBoundary = Unite(left, bottom);
  auto neumannBoundary = Unite(top, right);
  ...
  Integrands::PoissonTypeProblem<2> pde(dof1);
  ...
  visualize.WriteVtuFile("Electrostatics.vtu");
}
